...
namespace DBM
{
    public static class Handlers
    {
        ...
        public static Primitive TypeofSorts = "1=" + Language.Localization["Table"] + ";2=" + Language.Localization["View"] + ";3=" + Language.Localization["Index"] + ";4=" + Language.Localization["Master Table"] + ";";
